...
import Card from '../Feutures/Card'
function ExpereinceCard({expereince}) {
      return (
        <>
         {
            expereince.map(({title,project,technologies,detail},i) =>{
                return (
                       ...
                       <div className='w-full bg-black bg-opacity-20 py-10  hover:bg-opacity-30 duration-300 rounded-lg px-10 flex flex-col justify-center gap-10 shadow-xl shadow-slate-700'>
                        <div className=' '>
                            <div className='flex flex-col gap-3'>
                                ...
                                <p className='text-sm text-gray-300 hover:text-white duration-300'><span className='font-bold'>Project: </span> {project}</p>
                            </div>
