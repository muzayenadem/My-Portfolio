            ...
            group hover:bg-gradient-to-b hover:from-black hover:to-slate-800 transition-colors duration-1000'
                key={i}>
                    <div className='w-full h-[80%] overflow-hidden rounded-lg'>
                        <img className='w-full  object-cover group-hover:scale-110 duration-300 cursor-pointer'  src={img}/>
                        </div>
                    <div className='w-full mt-5 flex flex-col gap-6'>
                        <div className='flex items-center justify-between'>
                          <h3 className='text-xl font-bold uppercase text-rose-600'>{title}</h3>
                            <div className='flex justify-between'>
                                <a href='https://github.com/muzayenadem/Ecommerce'>
                                <span className='text-lg w-10 h-10 bg-black rounded-full text-slate-300  inline-flex justify-center  items-center hover:text-rose-800 duration-300'>
                                <FaGithub/>
                            </span>
                                </a>
